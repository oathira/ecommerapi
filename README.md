...
2) Open postman
3) Make a GET request on localhost:3000/products
4) The products should be visible
...
7) If you recieve the data with added product name and quantity then you have done everything correct.
